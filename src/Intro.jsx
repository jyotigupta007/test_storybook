...
//        };
        return (
          <div className="App-intro" style={{ maxWidth: 1000, margin: '0 auto' }}>
            ...
            <AppBar title={<span style={styles.title}>Title</span>} onClick={handleClick} showMenuIconButton={true} iconElementRight={<FlatButton label="Save" onClick={handleClick} />}  />
            <List>
               <ListItem
                  disabled={true}
              ...
              <ListItem
                  disabled={true}
                >                
                <Badge  badgeContent={10} secondary={true}>
                 <NotificationsIcon/>
                </Badge>
              </ListItem>
            </List>
